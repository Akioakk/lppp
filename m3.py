from PyQt5.QtWidgets import QWidget, QLineEdit, QHBoxLayout, QPushButton, QLabel, QVBoxLayout
...
v1_labels.addWidget(le_question)
v1_labels.addWidget(le_right_ans)
v1_labels.addWidget(le_wrong_ans1)
v1_labels.addWidget(le_wrong_ans2)
